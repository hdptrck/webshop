...
INSERT INTO webShopUser (userToken, firstname, lastname, email, password, role_idRole, active)
	VALUES
		...
		'Tester',
		'a@a.a',
		'$2y$10$AXNhJXjrubMu0/exfRQCz.jbKG7EfpR9Y8laPjXbXyJRIoZo25Yf2', 3, 1),
		...
		'Tester',
		'b@b.b',
		'$2y$10$W9bkMf0YvPEFzwkIiPvrC.vsve7J5HXlYR8AroVNiJ0UWb3KG00mu', 2, 1),
		...
		'Tester',
		'c@c.c',
		'$2y$10$jhzjKBF00SIKC2AJimtjk.aWG7BsjuATrbQcwj9zdpwTuzbBURCK6', 1, 1);
